...
class FrenchFries1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
            ...
            children: [
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 80,
                  child: Text(
                    'Indulge in our delicious, crispy, golden French Fries, a classic french fries favorite thats perfect as a side or a filling snack.',
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('images/prenprais1.png'),
                      fit: BoxFit.fill,
                    ),
                    boxShadow: [
                      BoxShadow(
