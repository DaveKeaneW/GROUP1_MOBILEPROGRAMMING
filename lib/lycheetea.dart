...
class lycheetea extends StatelessWidget {
  const lycheetea({Key? key});
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text('lychee Ice Tea added to your cart.'),
          actions: [
            TextButton(
              onPressed: () {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('images/leciicetea.png'),
                      fit: BoxFit.fill,
                    ),
                    boxShadow: [
                      BoxShadow(
